...
namespace MTExample1_8 {
	public class DrawingView : UIView {
		...
		public override void Draw (CGRect rect)
		{
			...
			var cm = new ColorMap ();
			var aFont = new Font ("Arial", 20, FontStyle.Bold);
		...
		void DrawColorBar (Graphics g, int x, int y, int width, int height, ColorMap map, string str)
		{
			...
			for (int i = 0; i < 32; i++) {
				int colorIndex = (i - ymin) * m / (ymax - ymin);
				var aBrush = new SolidBrush (Color.FromArgb(
