...
namespace MTExample4_9 {
	public class ChartStyle {
		...
		{
			// Set form1.PlotPanel:
			nfloat xOffset = ChartArea.Width / 30;
			nfloat yOffset = ChartArea.Height / 30;
			...
			nfloat xSpacing = xOffset / 3.0f;
			nfloat ySpacing = yOffset / 3.0f;
			CGSize tickFontSize = g.MeasureString ("A", TickFont);
		...
		void AddLabels (Graphics g)
		{
			...
			g.TranslateTransform ((float)(ChartArea.X + xOffset), (float)(ChartArea.Y + yOffset + titleFontSize.Height + yOffset / 3 + form1.PlotPanel.Height / 2));
