...
//
////			var theBrush2 = new LinearGradientBrush(r, Color.Red,
////			                                   Color.Blue,LinearGradientMode.Vertical);
//			var theBrush2 = new LinearGradientBrush(r, Color.Red,
//			                                        Color.Blue,0.0f);
//
////			theBrush2.RotateTransform(45);
////			theBrush2.ScaleTransform(2.0f, 2.0f);
//			//g.FillRectangle(theBrush2, dirtyRect);
//
...
//			LinearGradientBrush br = new LinearGradientBrush(dirtyRect, Color.Black, Color.Black, 0 , false);
...
//			g.FillEllipse(myLGBrush, 20, 150, 380, 50);
//
//			g.DrawString("Now is the time for all good men", Font, myLGBrush, myRect, new StringFormat());
			...
			g.DrawString("Look at this text!  It is Gradiented!!", myFont, myBrush, 10, 300);
